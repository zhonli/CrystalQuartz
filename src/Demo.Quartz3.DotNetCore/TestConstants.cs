...
namespace Demo.Quartz3.DotNetCore
{
    public static class TestConstants
    {
        static TestConstants()
        {
            ...
            SqlServerPassword = Environment.GetEnvironmentVariable("MSSQL_PASSWORD") ?? "123456a?";
            // we cannot use trusted connection as it's not available for Linux provider
            SqlServerConnectionString = $"Server=(localdb)\\ProjectsV13;Database=quartznet;User Id={SqlServerUser};Password={SqlServerPassword};";
